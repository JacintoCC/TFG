...
\section{Introducción a la inferencia}
	\input{capitulos/secciones/02_1_IntroduccionInferencia}	
	
	
\section{Test paramétricos}

	\input{capitulos/secciones/02_2_TestParametricos}
	
	\input{capitulos/secciones/02_3_EstadoArteTP}
...
\section{Test no paramétricos}
	...
	\subsection*{Comparación con test paramétricos}
		\input{capitulos/secciones/02_4_Comparacion}

	\input{capitulos/secciones/02_5_TestNoParametricos}
	
	\input{capitulos/secciones/02_6_EstadoArteTNP}
