...
problemas. Podemos encontrar los siguientes tipos de 
...
bayesiana. Para ilustrar la comparación, en el repositorio se 
incluye una serie de \textit{Notebooks} escritos en el
lenguaje \texttt{Julia} que representan un tutorial sobre
qué se puede hacer con estos métodos. 
